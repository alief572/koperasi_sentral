<div class="col-12">
    ...
    <div class="form-group">
        ...
        <input type="text" name="nm_katgeori_barang" id="" class="form-control form-control-sm" value="{{ (isset($get_kategori_barang)) ? $get_kategori_barang->nm_katgeori_barang : null }}">
    </div>
</div>