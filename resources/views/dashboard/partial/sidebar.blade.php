<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
        <img src="./dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
            style="opacity: .8">
        <span class="brand-text font-weight-light">Koperasi Sentral</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                <a href="#" class="d-block">{{ $logged_user->name }}</a>
            </div>
        </div>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="/tabungan_karyawan" class="nav-link">
                                <i class="fa fa-money nav-icon"></i>
                                <p>Tabungan Karyawan</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="/pemasukan_tabungan" class="nav-link">
                                <i class="fa fa-money nav-icon"></i>
                                <p>Pemasukan Tabungan</p>
                            </a>
                        </li>
                        <li class="nav-item">
